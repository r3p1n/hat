...
SECRET_KEY = 'django-insecure-kys!kxf9n169t8*t(y^l2d7s%j%cn&wzzyhe7gx3xi20qf1i0h'
...
STATIC_ROOT = os.path.join(BASE_DIR, 'staticfiles_build', 'static') # BASE_DIR/'staticfiles'
